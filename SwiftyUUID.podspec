#
#  Be sure to run `pod spec lint SwiftyUUID.podspec' to ensure this is a
...
Getting the raw UUID bytes out of NSUUID is painful and error prone.
  ...
  # Or just: s.author    = "Doug Richardson"
  # s.authors            = { "Doug Richardson" => "dougie.richardson@gmail.com" }
  # s.social_media_url   = "http://twitter.com/Doug Richardson"
